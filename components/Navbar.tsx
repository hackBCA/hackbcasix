...
export function Navbar() {
    ...
    return <header className={`w-full fixed z-10 top-0 left-0 right-0 hidden sm:flex items-center transition-all ${isPageAtTop ? "" : "bg-french-violet-600/90 dark:bg-french-violet-800/70 backdrop-blur-md border-b border-white/10"}`}>
